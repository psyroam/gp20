...
function putDate(n)
{
	...
	var d = x[0];
	var m = x[1];
	m = getMonthname(parseInt(m));
	var y = x[2];
	document.forms['myform'].elements['datum'].value = d+ " " + m + " " + y;
	document.forms['myform'].elements['event'].value = returnValue;
}
/**
...
function getEventtext(y,m,d)
{
	...
	h[0] = "13.9.2014|Daytona, Langenzersdorf";
	h[1] = "";
	h[2] = "";
	h[3] = "";
	h[4] = "";
